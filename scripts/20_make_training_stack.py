...
PATH = './workspace/data/raw/MOD06_L2/'
file_list = [os.path.join(dp, f) for dp, dn, filenames in os.walk(PATH) for f in filenames if os.path.splitext(f)[1] == '.hdf']

dest = './workspace/data/processed/patch_jpgs/'
